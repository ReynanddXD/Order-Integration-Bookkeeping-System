...
$orders = json_decode(file_get_contents("orders1.json"), true);
...
file_put_contents("order_detail1.json", $response);

header("Location: get_detail_order2.php");
exit;

echo "<h3>Order Detail Response (HTTP Status: $http_code):</h3><pre>$response</pre>";
?>
