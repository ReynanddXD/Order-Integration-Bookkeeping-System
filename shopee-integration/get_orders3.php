...
$url = BASE_URL . $path . "?" . http_build_query([
    ...
    'page_size' => 50,
    'cursor' => '',
    'order_status' => 'COMPLETED', // Hanya ambil order dengan status COMPLETED
...
file_put_contents("orders3.json", $response); // Tambahkan baris ini

header("Location: get_detail_order1.php");
exit;
?>
